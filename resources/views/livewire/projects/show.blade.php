<div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {{-- Kolom Kanan: Papan Kanban Task --}}
            <div class="md:col-span-2">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Tasks Board</h3>
                        ...
                        <form wire:submit="storeTask">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input wire:model="deadline" id="deadline" class="block mt-1 w-full"
            ...
            @if ($isConfirmingTaskDelete)
                <div class="fixed inset-0 flex items-center justify-center z-50">
                    <div class="absolute inset-0 bg-black opacity-50"
                        wire:click="$set('isConfirmingTaskDelete', false)">
                    </div>
                                ...
                                @if ($editingTaskTitleId === $viewingTask->id)
                                    <div class="flex items-center gap-2">
                                        <x-text-input wire:model="newTitle" wire:keydown.enter="updateTaskTitle"
                                            ...
                                            class="py-1 text-2xl font-bold w-full" />
                                    </div>
                                ...
                                <div class="text-xs text-gray-500 dark:text-gray-400">
                                    @if ($editingTaskDateId === $task->id)
                                        <div class="flex items-center gap-2">
                                            ...
                                            <button wire:click="cancelEditingDate()"
                                ...
                                @else
                                    <div>
                                        <input type="file" wire:model.live="file"
                                            id="task-file-{{ $viewingTask->id }}" class="text-sm">
